...
When we incorporate the real property values, a few interesting things happen.  Cash flow in the model remains unchanged.  At some point, it will likely come in line with the higher real estate prices.  However, our model doesn't reflect that in any way.
...
----compute delta cash over elapsed Time

----compute ROE over elapsed time
