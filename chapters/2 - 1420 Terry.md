...
Given that the 3.5% rate is a historical anomaly, I'll hold onto it for the lifetime of the loan.  In the model, the PMI payment of $290 remains constant until it disappears when the equity requirements are met.  The tax payments is computed from the number in year one with an adjustment that tracks the rate of appreciation/inflation.  In this case that's 3%.  It's almost certain that rate will increase at some point, but that's all upside.  Not assuming that makes this model conservative.

Similarly, the HOA payment was $454 in year 1.  That adjusts upward with the rate of appreciation.  All other calculations follow from those assumptions.

![1420 - Equity and Return](/images/2/1420%20-%20Equity%20and%20Return.png)
