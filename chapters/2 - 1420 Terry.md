...
Contrast that with company B.  To grow 10% it needs to increase revenues from $100m to $110.  That's nothing to sneeze at either.  However, depending on the industry, a single contract might well make that growth target possible.
...
Similarly, consider to companies:
...
But, you came here to learn about real estate, not equities...  In our model we have ROE dropping off as equity increases.  This is an unavoidable side effect of success.  Two factors, the appreciation of the property and the payoff of the loan combine to decrease leverage.  As leverage decreases, the ROE approaches the return of the underlying asset.
...
We immediately notice that the initial ROE has jumped substantially.  This shouldn't be surprising at there is now a substantial difference between the 3.5% interest rate on the loan and the rate at which the value of the property is growing.  That leads us to an important point - A fixed rate mortgage is a bet that interest rates will increase.

The impact of payoff in 2042 is now almost imperceptible in the graph.
...
In the model, the PMI payment of $290 remains constant until it disappears when the equity requirements are met.  The tax payment is computed from the number in year one with an adjustment that tracks the rate of appreciation/inflation.  In this case that's 3%.  It's almost certain that rate will increase at some point, but that's all upside.  Not assuming that makes this model conservative.

Similarly, the HOA payment was $454 in year one.  That adjusts upward with the rate of appreciation.  All other calculations follow from those assumptions.
