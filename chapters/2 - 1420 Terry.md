...
Finally, post tensioned slabs end up sort of wavey given that they're both poured and tensioned.  The carpeting had covered that up pretty well.  The wood flooring wouldn't.  The solution was self leveling compound.  That seems to be a fancy name for very runny concrete.  It self levels and then dries, resolving the issue.
